...
const APPOINTMENTS_VEHICLE_CHECKIN = APPOINTMENTS_ROUTE + '/v_checkin';
const APPOINTMENTS_VEHICLE_CHECKOUT = APPOINTMENTS_ROUTE + '/v_checkout';
...
export const APPOINTMENT_VEHICLE_CHECKIN_URL = BASE_URL + APPOINTMENTS_VEHICLE_CHECKIN;
export const APPOINTMENT_VEHICLE_CHECKOUT_URL = BASE_URL + APPOINTMENTS_VEHICLE_CHECKOUT;
